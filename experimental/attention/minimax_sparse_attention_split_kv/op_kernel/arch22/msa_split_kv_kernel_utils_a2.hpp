...
#ifndef MINIMAX_SA_SPLIT_KV_A2_MSA_SPLIT_KV_KERNEL_UTILS_A2
#define MINIMAX_SA_SPLIT_KV_A2_MSA_SPLIT_KV_KERNEL_UTILS_A2
...
struct MinimaxSaSplitKvKernelParamsA2 {
    GM_ADDR q;
    GM_ADDR k;
    GM_ADDR v;
    GM_ADDR blockTable;
    ...
    __aicore__ inline MinimaxSaSplitKvKernelParamsA2() {}

    __aicore__ inline MinimaxSaSplitKvKernelParamsA2(GM_ADDR q_, GM_ADDR k_, GM_ADDR v_, GM_ADDR blockTable_,
                                                     GM_ADDR k2qRowPtr_, GM_ADDR k2qQIndices_, GM_ADDR k2qSlotIndices_,
                                                     GM_ADDR actualQseqlen_, GM_ADDR actualKvseqlen_, GM_ADDR o_,
...
#endif // MINIMAX_SA_SPLIT_KV_A2_MSA_SPLIT_KV_KERNEL_UTILS_A2
