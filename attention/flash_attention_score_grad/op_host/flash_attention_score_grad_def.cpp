...
public:
    explicit FlashAttentionScoreGrad(const char *name)
        : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
            .DataType({ge::DT_FLOAT16,       ge::DT_BF16,         ge::DT_FLOAT16,       ge::DT_BF16,
                       ...
                       ge::DT_FLOAT,         ge::DT_FLOAT,        ge::DT_HIFLOAT8,      ge::DT_HIFLOAT8,
        ...
        this->Input("dy")
            ...
            .DataType({ge::DT_FLOAT16, ge::DT_BF16, ge::DT_FLOAT16, ge::DT_BF16,  ge::DT_FLOAT16,  ge::DT_BF16,
                       ge::DT_FLOAT16, ge::DT_BF16, ge::DT_FLOAT,   ge::DT_FLOAT, ge::DT_HIFLOAT8, ge::DT_HIFLOAT8,
        ...
        this->Input("atten_mask")
            .ParamType(OPTIONAL)
            .DataType({ge::DT_UINT8, ge::DT_UINT8, ge::DT_BOOL,  ge::DT_BOOL, ge::DT_UINT8, ge::DT_UINT8,
                       ge::DT_BOOL,  ge::DT_BOOL,  ge::DT_UINT8, ge::DT_BOOL, ge::DT_UINT8, ge::DT_BOOL,
                       ge::DT_UINT8, ge::DT_BOOL,  ge::DT_UINT8, ge::DT_BOOL, ge::DT_BOOL,  ge::DT_UINT8,
                       ge::DT_BOOL,  ge::DT_UINT8, ge::DT_BOOL,  ge::DT_UINT8})
            .Format({ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND,
                     ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND,
                     ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND,
                     ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND})
        ...
        this->Attr("pre_tockens").AttrType(OPTIONAL).Int(2147483647);  // default pre_tockens
        this->Attr("next_tockens").AttrType(OPTIONAL).Int(2147483647); // default next_tockens
        this->Attr("head_num").AttrType(REQUIRED).Int();
        this->Attr("input_layout").AttrType(REQUIRED).String();
        this->Attr("inner_precise").AttrType(OPTIONAL).Int(0); // 0, fp16 high precision; 1, high performance
        this->Attr("sparse_mode").AttrType(OPTIONAL).Int(0);
        this->Attr("pse_type").AttrType(OPTIONAL).Int(1);
        this->Attr("seed").AttrType(OPTIONAL).Int(2); // default seed
        this->Attr("offset").AttrType(OPTIONAL).Int(0);
        this->Attr("out_dtype").AttrType(OPTIONAL).Int(0);
        this->Attr("softmax_in_layout").AttrType(OPTIONAL).String("");
        ...
        this->AICore().AddConfig("ascend350", aicore_config_95);
