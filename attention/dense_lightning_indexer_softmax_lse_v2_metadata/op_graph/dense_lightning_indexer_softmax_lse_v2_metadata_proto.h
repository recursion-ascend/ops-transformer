...
/*!
 * \\file dense_lightning_indexer_softmax_lse_v2_metadata_proto.h
 * \brief
 */
#ifndef DENSE_LIGHTNING_INDEXER_SOFTMAX_LSE_V2_METADATA_PROTO_H
#define DENSE_LIGHTNING_INDEXER_SOFTMAX_LSE_V2_METADATA_PROTO_H
...
REG_OP(DenseLightningIndexerSoftmaxLseV2Metadata)
    ...
    .OP_END_FACTORY_REG(DenseLightningIndexerSoftmaxLseV2Metadata)

} // namespace ge

#endif // DENSE_LIGHTNING_INDEXER_SOFTMAX_LSE_V2_METADATA_PROTO_H
