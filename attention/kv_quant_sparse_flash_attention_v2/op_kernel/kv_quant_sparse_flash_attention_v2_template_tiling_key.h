...
/*!
 * \file kv_quant_sparse_flash_attention_v2_template_tiling_key.h
 * \brief
 */

#ifndef KV_QUANT_SPARSE_FLASH_ATTENTION_V2_TEMPLATE_TILING_KEY_H
#define KV_QUANT_SPARSE_FLASH_ATTENTION_V2_TEMPLATE_TILING_KEY_H
...
// 模板参数支持的范围定义
ASCENDC_TPL_ARGS_DECL(KvQuantSparseFlashAttentionV2, // 算子OpType
