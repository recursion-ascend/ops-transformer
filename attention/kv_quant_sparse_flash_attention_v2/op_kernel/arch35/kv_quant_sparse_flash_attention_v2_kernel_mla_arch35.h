...
/*!
 * \file kv_quant_sparse_flash_attention_v2_kernel_mla_arch35.h
 * \brief
 */

#ifndef KV_QUANT_SPARSE_FLASH_ATTENTION_V2_KERNEL_MLA_ARCH35_H
#define KV_QUANT_SPARSE_FLASH_ATTENTION_V2_KERNEL_MLA_ARCH35_H
...
#include "kv_quant_sparse_flash_attention_v2_service_cube_mla_arch35.h"
#include "kv_quant_sparse_flash_attention_v2_service_vector_mla_arch35.h"
#include "kv_quant_sparse_flash_attention_v2_common_arch35.h"
#include "kv_quant_sparse_flash_attention_v2_kvcache.h"
...
class KvQuantSparseFlashAttentionV2Mla {
public:
    ARGS_TRAITS;

    __aicore__ inline KvQuantSparseFlashAttentionV2Mla(){};
    __aicore__ inline void Init(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
                                ...
                                const KvQuantSparseFlashAttentionV2TilingDataMla *__restrict tiling, TPipe *tPipe);
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void KvQuantSparseFlashAttentionV2Mla<CubeBlockType, VecBlockType>::Init(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void KvQuantSparseFlashAttentionV2Mla<CubeBlockType, VecBlockType>::InitCalcParamsEach()
{
    // 计算总的基本块
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline uint64_t KvQuantSparseFlashAttentionV2Mla<CubeBlockType, VecBlockType>::GetBalanceActualSeqLengths(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void KvQuantSparseFlashAttentionV2Mla<CubeBlockType, VecBlockType>::GetAxisStartIdx(
    uint32_t bN2EndPrev, uint32_t s1GEndPrev, uint32_t s2EndPrev)
{
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void KvQuantSparseFlashAttentionV2Mla<CubeBlockType, VecBlockType>::InitGlobalBuffer(
    __gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value, __gm__ uint8_t *sparseIndices,
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void KvQuantSparseFlashAttentionV2Mla<CubeBlockType, VecBlockType>::InitMMResBuf(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void KvQuantSparseFlashAttentionV2Mla<CubeBlockType, VecBlockType>::InitMMResBufUb()
{
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void KvQuantSparseFlashAttentionV2Mla<CubeBlockType, VecBlockType>::InitMMResBufGm(
    __gm__ uint8_t *workspace)
{
    if constexpr (IS_SPLIT_G) {
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void KvQuantSparseFlashAttentionV2Mla<CubeBlockType, VecBlockType>::InitLocalBuffer()
{
    vecBlock.InitLocalBuffer(pipe, constInfo);
}

template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void KvQuantSparseFlashAttentionV2Mla<CubeBlockType, VecBlockType>::ComputeConstexpr()
{
    // 计算轴的乘积
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void KvQuantSparseFlashAttentionV2Mla<CubeBlockType, VecBlockType>::InitUniqueConstInfo()
{
    // bsize + 1-> bsize
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void KvQuantSparseFlashAttentionV2Mla<CubeBlockType, VecBlockType>::Process()
{
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void KvQuantSparseFlashAttentionV2Mla<CubeBlockType, VecBlockType>::ProcessMainLoop()
{
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void KvQuantSparseFlashAttentionV2Mla<CubeBlockType, VecBlockType>::ComputeAxisIdxByBnAndGs1(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void KvQuantSparseFlashAttentionV2Mla<CubeBlockType, VecBlockType>::SetRunInfo(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void KvQuantSparseFlashAttentionV2Mla<CubeBlockType, VecBlockType>::InitUniqueRunInfo(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void KvQuantSparseFlashAttentionV2Mla<CubeBlockType, VecBlockType>::ComputeBmm1Tail(
...
#endif // KV_QUANT_SPARSE_FLASH_ATTENTION_V2_KERNEL_MLA_ARCH35_H
