...
# 脚本路径
PT_SAVE_SCRIPT="./batch/test_kv_quant_sparse_flash_attention_v2_pt_save.py"
GEN_EXCEL_SCRIPT="./batch/gen_excel_from_paramset.py"
TEST_BATCH_SCRIPT="test_kv_quant_sparse_flash_attention_v2_batch.py"
TEST_SINGLE_SCRIPT="test_kv_quant_sparse_flash_attention_v2_single.py"
...
show_help() {
    ...
    echo "                选项: -P paramset_file (指定 paramset 文件名，默认: kv_quant_sparse_flash_attention_v2_paramset)"
    echo ""
