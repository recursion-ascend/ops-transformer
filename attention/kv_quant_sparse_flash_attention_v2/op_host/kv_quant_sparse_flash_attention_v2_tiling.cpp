...
/*!
 * \file kv_quant_sparse_flash_attention_v2_tiling.cpp
 * \brief
 */
...
#include "../op_kernel/kv_quant_sparse_flash_attention_v2_template_tiling_key.h"
...
const std::map<std::string, std::vector<QSFAV2Layout>> LAYOUT_SUPPORT_MAP = {
    {QUERY_NAME, {QSFAV2Layout::BSND, QSFAV2Layout::TND}},
    {KEY_NAME, {QSFAV2Layout::BSND, QSFAV2Layout::TND, QSFAV2Layout::PA_BSND}},
    {VALUE_NAME, {QSFAV2Layout::BSND, QSFAV2Layout::TND, QSFAV2Layout::PA_BSND}},
    {ATTEN_OUT_NAME, {QSFAV2Layout::BSND, QSFAV2Layout::TND}},
};
...
static const std::map<QSFAV2Layout, std::vector<QSFAV2Axis>> QSFAV2_LAYOUT_AXIS_MAP = {
    {QSFAV2Layout::BSND, {QSFAV2Axis::B, QSFAV2Axis::S, QSFAV2Axis::N, QSFAV2Axis::D}},
    {QSFAV2Layout::TND, {QSFAV2Axis::T, QSFAV2Axis::N, QSFAV2Axis::D}},
    {QSFAV2Layout::PA_BSND, {QSFAV2Axis::Bn, QSFAV2Axis::Bs, QSFAV2Axis::N, QSFAV2Axis::D}},
};

static const std::map<QSFAV2Layout, size_t> QSFAV2_LAYOUT_DIM_MAP = {
    {QSFAV2Layout::BSND, DIM_NUM_FOUR},
    {QSFAV2Layout::TND, DIM_NUM_THREE},
    {QSFAV2Layout::PA_BSND, DIM_NUM_FOUR},
};
...
string QSFAV2TensorDesc2String(const gert::StorageShape *shape, const gert::CompileTimeTensorDesc *tensor)
{
...
string QSFAV2DebugTilingContext(const gert::TilingContext *context)
{
    std::ostringstream qsfaOss;
    for (size_t i = 0; i < context->GetComputeNodeInfo()->GetInputsNum(); ++i) {
        qsfaOss << "input" << i << ": ";
        qsfaOss << QSFAV2TensorDesc2String(context->GetInputShape(i), context->GetInputDesc(i));
    }

    for (size_t i = 0; i < context->GetComputeNodeInfo()->GetOutputsNum(); ++i) {
        qsfaOss << "output" << i << ": ";
        qsfaOss << QSFAV2TensorDesc2String(context->GetOutputShape(i), context->GetOutputDesc(i));
    }
    return qsfaOss.str();
}
...
{
    switch (layout) {
        case QSFAV2Layout::BSND:
            return "BSND";
        case QSFAV2Layout::TND:
            return "TND";
        case QSFAV2Layout::PA_BSND:
            return "PA_BSND";
        default:
            return "UNKNOWN";
    }
...
ge::graphStatus QSFAV2MlaTiling::SetBlockDim(uint32_t blockDim) const
{
    context_->SetBlockDim(blockDim);
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2MlaTiling::SetTilingKey(uint64_t tilingKey) const
{
...
ge::graphStatus QSFAV2MlaTiling::SetWorkspaceSize(uint64_t workspaceSize) const
{
...
ge::graphStatus QSFAV2MlaTiling::SetTilingData(TilingDef &tilingData) const
{
...
ge::graphStatus QSFAV2MlaTiling::GetPlatformInfo()
{
...
void QSFAV2MlaTiling::CalcVectorizeFlag()
{
    ...
    if (qsfaInfo_->kvLayout == QSFAV2Layout::PA_BSND) {
...
void QSFAV2MlaTiling::GenTilingKey()
{
    ...
    tilingKey_ =
        GET_TPL_TILING_KEY(0U, pageAttention, layoutQuery, layoutKV, perfMode_ == QSFAV2PerfMode::V_TEMPLATE_MODE,
                           static_cast<uint32_t>(qsfaInfo_->gSize > 64), vectorizeFlag_); // G大于64时核间切G
    OP_LOGI(qsfaInfo_->opName, "QSFAV2 tilingKey_: %lu.", tilingKey_);
}

void QSFAV2MlaTiling::ZeroTensorProcess() const
{
...
void QSFAV2MlaTiling::InitParams()
{
    perfMode_ = QSFAV2PerfMode::V_TEMPLATE_MODE;
    coreNum_ = aicNum_;
...
void QSFAV2MlaTiling::CalcUbBmm()
{
...
void QSFAV2MlaTiling::CheckUbSpace()
{
    CalcUbBmm();
}

void QSFAV2MlaTiling::CalcInnerSize(uint32_t qsfaS2Size)
{
    sInnerSize_ = 512; // 512:s2默认切分大小
    // FlashDecode时，如果S2的计算量>=256(确保切分后不小于128)但又不足以分2次计算时，则修改sInnerSize_，均分为2份进行计算，确保Nbuffer=2
    if (splitKVFlag_ && qsfaInfo_->qLayout != QSFAV2Layout::TND) {
...
void QSFAV2MlaTiling::SplitBalanced()
{
...
void QSFAV2MlaTiling::Split()
{
    SplitBalanced();
}

void QSFAV2MlaTiling::FillTilingBaseParamsMla()
{
...
// for flash decode
void QSFAV2MlaTiling::FillTilingSplitKVMla()
{
...
void QSFAV2MlaTiling::FillTilingSingleCoreParamsMla()
{
    tilingData_.singleCoreParams.set_usedCoreNum(usedCoreNum_);
}

void QSFAV2MlaTiling::FillTilingSingleCoreTensorSizeMla()
{
...
void QSFAV2MlaTiling::FillTiling()
{
...
uint32_t QSFAV2MlaTiling::CalcBalanceFDParamNums(const uint32_t actCoreNum) const
{
    return actCoreNum * 2 * qsfaInfo_->n2Size * mBaseSize_; // 2:每个核可能有头规约和尾规约，一共两份规约信息
}

void QSFAV2MlaTiling::NormalCalcFDWorkSpace(const uint32_t actCoreNum)
{
    if (splitKVFlag_) {
...
void QSFAV2MlaTiling::CalcFDWorkSpace(const uint32_t actCoreNum)
{
    NormalCalcFDWorkSpace(actCoreNum);
}

void QSFAV2MlaTiling::GetWorkspaceSize()
{
    ...
    if (qsfaInfo_->isA5) {
        ...
        if (vectorizeFlag_) {
            uint32_t totalBS1 =
                (qsfaInfo_->qLayout == QSFAV2Layout::TND) ? qsfaInfo_->s1Size : (qsfaInfo_->bSize * qsfaInfo_->s1Size);
...
void QSFAV2MlaTiling::CalcBlockDim()
{
    auto ascendcPlatform = platform_ascendc::PlatformAscendC(qsfaInfo_->platformInfo);
    ...
    OP_LOGI(qsfaInfo_->opName, "QSFAV2 block dim: %u aiv Num: %u aic Num: %u.", blockDim_, aivNum, aicNum);
}

ge::graphStatus QSFAV2MlaTiling::DoOpTiling(QSFAV2TilingInfo *qsfaInfo)
{
    qsfaInfo_ = qsfaInfo;
...
ge::graphStatus TilingKvQuantSparseFlashAttentionV2(gert::TilingContext *context)
{
    QSFAV2TilingInfo qsfaInfo;
    QSFAV2InfoParser qsfaInfoParser(context);
    if (qsfaInfoParser.Parse(qsfaInfo) != ge::GRAPH_SUCCESS) {
        return ge::GRAPH_FAILED;
    }

    QSFAV2TilingCheck tilingChecker(qsfaInfo);
    if (tilingChecker.Process() != ge::GRAPH_SUCCESS) {
        return ge::GRAPH_FAILED;
    }

    QSFAV2MlaTiling tiling(context);
    return tiling.DoOpTiling(&qsfaInfo);
}

ge::graphStatus TilingPrepareForKvQuantSparseFlashAttentionV2(gert::TilingParseContext *const context)
{
    (void)context;
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2TilingCheck::GetExpectedShape(gert::Shape &shapeExpected,
                                                    const QSFAV2TilingShapeCompareParam &param,
                                                    const QSFAV2Layout &layout) const
{
    if (layout == QSFAV2Layout::BSND) {
        shapeExpected = gert::Shape({param.B, param.S, param.N, param.D});
    } else if (layout == QSFAV2Layout::TND) {
        shapeExpected = gert::Shape({param.T, param.N, param.D});
    } else if (layout == QSFAV2Layout::PA_BSND) {
        shapeExpected = gert::Shape({param.Bn, param.Bs, param.N, param.D});
    } else {
        OP_LOGE(opName_, "layout %s is unsupported", QSFAV2LayoutToSerialString(layout).c_str());
        return ge::GRAPH_FAILED;
    }
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2TilingCheck::CompareShape(QSFAV2TilingShapeCompareParam &param, const gert::Shape &shape,
...
void QSFAV2TilingCheck::LogErrorDtypeSupport(const std::vector<ge::DataType> &expectDtypeList,
                                             const ge::DataType &actualDtype, const std::string &name) const
{
    std::ostringstream qsfaOss;
    for (size_t i = 0; i < expectDtypeList.size(); ++i) {
        qsfaOss << QSFAV2DataTypeToSerialString(expectDtypeList[i]);
        if (i < expectDtypeList.size() - 1) {
            qsfaOss << ", ";
        }
    }
    OP_LOGE_FOR_INVALID_DTYPE_WITH_REASON(opName_, name.c_str(), QSFAV2DataTypeToSerialString(actualDtype).c_str(),
                                          "The dtype of " + name + " must be " + qsfaOss.str());
}

ge::graphStatus QSFAV2TilingCheck::CheckDtypeSupport(const gert::CompileTimeTensorDesc *qsfaDesc,
...
template <typename T>
void QSFAV2TilingCheck::LogErrorNumberSupport(const std::vector<T> &expectNumberList, const T &actualValue,
...
template <typename T>
void QSFAV2TilingCheck::LogErrorDimNumSupport(const std::vector<T> &expectNumberList, const T &actualValue,
                                              const std::string &name) const
{
    LogErrorNumberSupport(expectNumberList, actualValue, name, "dimension");
}

ge::graphStatus QSFAV2TilingCheck::CheckDimNumInLayoutSupport(const QSFAV2Layout &layout,
                                                              const gert::StorageShape *shape,
                                                              const std::string &name) const
{
    const auto &qsfaDimIt = QSFAV2_LAYOUT_DIM_MAP.find(layout);
    OP_CHECK_IF(shape->GetStorageShape().GetDimNum() != qsfaDimIt->second,
                OP_LOGE_FOR_INVALID_SHAPEDIM_WITH_REASON(
                    ...
                    "When layout is " + QSFAV2LayoutToSerialString(layout) + ", the shape dim of " + name +
                        " should be " + std::to_string(qsfaDimIt->second)),
                return ge::GRAPH_FAILED);
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2TilingCheck::CheckDimNumSupport(const gert::StorageShape *shape,
...
void QSFAV2TilingCheck::LogErrorLayoutSupport(const std::vector<QSFAV2Layout> &expectLayoutList,
                                              const QSFAV2Layout &actualLayout, const std::string &name) const
{
    std::ostringstream qsfaOssLayout;
    for (size_t i = 0; i < expectLayoutList.size(); ++i) {
        qsfaOssLayout << QSFAV2LayoutToSerialString(expectLayoutList[i]);
        if (i < expectLayoutList.size() - 1) {
            qsfaOssLayout << ", ";
        }
    }
    OP_LOGE_FOR_INVALID_VALUE_WITH_REASON(opName_, name.c_str(), QSFAV2LayoutToSerialString(actualLayout).c_str(),
                                          "Tensor " + name + " only supports layout " + qsfaOssLayout.str());
}

ge::graphStatus QSFAV2TilingCheck::CheckLayoutSupport(const QSFAV2Layout &actualLayout, const std::string &name) const
{
...
ge::graphStatus QSFAV2TilingCheck::CheckSingleParaQuery() const
{
...
ge::graphStatus QSFAV2TilingCheck::CheckSingleParaKey() const
{
...
ge::graphStatus QSFAV2TilingCheck::CheckSingleParaNumHeads() const
{
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2TilingCheck::CheckSingleParaKvHeadNums() const
{
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2TilingCheck::CheckSingleParaSparseMode() const
{
    OP_CHECK_IF(
...
ge::graphStatus QSFAV2TilingCheck::CheckSingleParaSparseBlockSize() const
{
...
ge::graphStatus QSFAV2TilingCheck::CheckSingleParaSparseIndices() const
{
...
ge::graphStatus QSFAV2TilingCheck::CheckSingleParaSinks() const
{
...
ge::graphStatus QSFAV2TilingCheck::CheckSingleParaDequantScale() const
{
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2TilingCheck::CheckSinglePara() const
{
    if (ge::GRAPH_SUCCESS != CheckSingleParaQuery() || ge::GRAPH_SUCCESS != CheckSingleParaKey() ||
        ...
        ge::GRAPH_SUCCESS != CheckSingleParaDequantScale()) {
        return ge::GRAPH_FAILED;
    }
...
template <typename T>
ge::graphStatus QSFAV2TilingCheck::CheckAttrValueByMap(std::map<std::string, std::pair<const T *, T>> &attrMap) const
{
...
ge::graphStatus QSFAV2TilingCheck::CheckParaExistenceMlaAntiquant() const
{
    if (kvLayout_ == QSFAV2Layout::BSND) {
        return ge::GRAPH_SUCCESS;
    } else if (kvLayout_ == QSFAV2Layout::TND) {
        OP_CHECK_IF(
            ...
            return ge::GRAPH_FAILED);
    } else if (kvLayout_ == QSFAV2Layout::PA_BSND) {
        OP_CHECK_IF(
            opParamInfo_.actualSeqLengths.tensor == nullptr,
...
ge::graphStatus QSFAV2TilingCheck::CheckParaExistenceMla() const
{
    return CheckParaExistenceMlaAntiquant();
}

ge::graphStatus QSFAV2TilingCheck::CheckParaExistence()
{
...
void QSFAV2TilingCheck::SetQSFAV2ShapeCompare()
{
...
ge::graphStatus QSFAV2TilingCheck::CheckBlockTable() const
{
    if (kvStorageMode_ != KvStorageMode::PAGE_ATTENTION) {
        OP_CHECK_IF(
            ...
            OP_LOGE_FOR_INVALID_ARGUMENT_WITH_REASON(
                ...
                "When the layout_kv is " + QSFAV2LayoutToSerialString(kvLayout_) + ", block_table should be null"),
            return ge::GRAPH_FAILED);
        return ge::GRAPH_SUCCESS;
    }
...
ge::graphStatus QSFAV2TilingCheck::CheckDTypeConsistency(const ge::DataType &actualDtype,
                                                         const ge::DataType &expectDtype, const std::string &name) const
{
    if (actualDtype != expectDtype) {
        OP_LOGE_FOR_INVALID_DTYPE_WITH_REASON(
            opName_, name.c_str(), QSFAV2DataTypeToSerialString(actualDtype).c_str(),
            "The dtype of " + name + " must be " + QSFAV2DataTypeToSerialString(expectDtype));
        return ge::GRAPH_FAILED;
    }
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2TilingCheck::CheckTopkShape()
{
    QSFAV2TilingShapeCompareParam qsfaShapeParams;
...
ge::graphStatus QSFAV2TilingCheck::CheckAttenOutShape()
{
    QSFAV2TilingShapeCompareParam shapeParams;
...
ge::graphStatus QSFAV2TilingCheck::CheckAttenOut()
{
    if (ge::GRAPH_SUCCESS !=
...
ge::graphStatus QSFAV2TilingCheck::CheckTopK()
{
...
ge::graphStatus QSFAV2TilingCheck::CheckKVShapeForBatchContinuous()
{
    QSFAV2TilingShapeCompareParam shapeParams;
    shapeParams.B = bSize_;
...
ge::graphStatus QSFAV2TilingCheck::CheckKVShapeForPageAttention()
{
...
ge::graphStatus QSFAV2TilingCheck::CheckKVShape()
{
...
ge::graphStatus QSFAV2TilingCheck::CheckKV()
{
...
ge::graphStatus QSFAV2TilingCheck::CheckActualSeqLensQ()
{
...
ge::graphStatus QSFAV2TilingCheck::CheckActualSeqLensQDType()
{
    ...
    if (opParamInfo_.actualSeqLengthsQ.desc->GetDataType() != ge::DT_INT32) {
        OP_LOGE_FOR_INVALID_DTYPE_WITH_REASON(
            opName_, "actual_seq_lengths_query",
            QSFAV2DataTypeToSerialString(opParamInfo_.actualSeqLengthsQ.desc->GetDataType()).c_str(),
...
ge::graphStatus QSFAV2TilingCheck::CheckActualSeqLensQShape()
{
...
ge::graphStatus QSFAV2TilingCheck::CheckActualSeqLens()
{
...
ge::graphStatus QSFAV2TilingCheck::CheckActualSeqLensDType()
{
    ...
    if (opParamInfo_.actualSeqLengths.desc->GetDataType() != ge::DT_INT32) {
        OP_LOGE_FOR_INVALID_DTYPE_WITH_REASON(
            opName_, "actual_seq_lengths_kv",
            QSFAV2DataTypeToSerialString(opParamInfo_.actualSeqLengths.desc->GetDataType()).c_str(),
...
ge::graphStatus QSFAV2TilingCheck::CheckActualSeqLensShape()
{
...
ge::graphStatus QSFAV2TilingCheck::CheckMultiParaConsistency()
{
    SetQSFAV2ShapeCompare();
...
ge::graphStatus QSFAV2TilingCheck::CheckFeatureMlaAntiquantShape() const
{
...
ge::graphStatus QSFAV2TilingCheck::CheckFeatureMlaAntiquantShapeSizes() const
{
    ...
    OP_CHECK_IF(qTSize_ <= 0 && (qLayout_ == QSFAV2Layout::TND),
                OP_LOGE_FOR_INVALID_SHAPE_WITH_REASON(
                    opName_, "query", ToStringRaw(opParamInfo_.query.shape->GetStorageShape()).c_str(),
...
ge::graphStatus QSFAV2TilingCheck::CheckFeatureMlaAntiquantShapeSparseAndHeadDim() const
{
    if (isA5_) {
...
ge::graphStatus QSFAV2TilingCheck::CheckFeatureMlaAntiquantLayout() const
{
...
ge::graphStatus QSFAV2TilingCheck::CheckFeatureMlaAntiquantDtype() const
{
    OP_CHECK_IF(inputQType_ != ge::DT_BF16 && inputQType_ != ge::DT_FLOAT16,
                OP_LOGE_FOR_INVALID_DTYPE_WITH_REASON(
                    opName_, "query", QSFAV2DataTypeToSerialString(inputQType_).c_str(),
                    "The dtype of query must be " + QSFAV2DataTypeToSerialString(ge::DT_BF16) + " and " +
                        QSFAV2DataTypeToSerialString(ge::DT_FLOAT16)),
                return ge::GRAPH_FAILED);
    ...
    if (isA5_) {
        OP_CHECK_IF(
            ...
            OP_LOGE_FOR_INVALID_DTYPES_WITH_REASON(
                opName_, "key and value", QSFAV2DataTypeToSerialString(inputKvType_).c_str(),
                "The dtype of key and value must be " + QSFAV2DataTypeToSerialString(ge::DT_FLOAT8_E4M3FN) + ", " +
                    QSFAV2DataTypeToSerialString(ge::DT_HIFLOAT8) + " or " + QSFAV2DataTypeToSerialString(ge::DT_INT8)),
            return ge::GRAPH_FAILED);
    } else {
        OP_CHECK_IF(inputKvType_ != ge::DT_INT8,
                    OP_LOGE_FOR_INVALID_DTYPES_WITH_REASON(
                        opName_, "key and value", QSFAV2DataTypeToSerialString(inputKvType_).c_str(),
                        "The dtype of key and value must be " + QSFAV2DataTypeToSerialString(ge::DT_INT8)),
                    return ge::GRAPH_FAILED);
    }
...
ge::graphStatus QSFAV2TilingCheck::CheckFeatureMlaAntiquantAttr() const
{
...
ge::graphStatus QSFAV2TilingCheck::CheckFeatureMlaAntiquantPa() const
{
    if (kvStorageMode_ != KvStorageMode::PAGE_ATTENTION) {
        return ge::GRAPH_SUCCESS;
    }
...
ge::graphStatus QSFAV2TilingCheck::CheckFeatureMlaAntiquant() const
{
...
ge::graphStatus QSFAV2TilingCheck::CheckFeatureMla() const
{
    return CheckFeatureMlaAntiquant();
}

ge::graphStatus QSFAV2TilingCheck::CheckFeature() const
{
    return CheckFeatureMla();
}

void QSFAV2TilingCheck::Init()
{
...
ge::graphStatus QSFAV2TilingCheck::Process()
{
    Init();
...
static bool HasAxis(const QSFAV2Axis &axis, const QSFAV2Layout &layout, const gert::Shape &shape)
{
    const auto &qsfaLayoutIt = QSFAV2_LAYOUT_AXIS_MAP.find(layout);
    if (qsfaLayoutIt == QSFAV2_LAYOUT_AXIS_MAP.end()) {
        return false;
    }

    const std::vector<QSFAV2Axis> &qsfaAxes = qsfaLayoutIt->second;
    ...
    const auto &qsfaDimIt = QSFAV2_LAYOUT_DIM_MAP.find(layout);
    if (qsfaDimIt == QSFAV2_LAYOUT_DIM_MAP.end() || qsfaDimIt->second != shape.GetDimNum()) {
        return false;
    }
...
static size_t GetAxisIdx(const QSFAV2Axis &axis, const QSFAV2Layout &layout)
{
    const std::vector<QSFAV2Axis> &axes = QSFAV2_LAYOUT_AXIS_MAP.find(layout)->second;
    const auto &axisIt = std::find(axes.begin(), axes.end(), axis);

    return std::distance(axes.begin(), axisIt);
}

static uint32_t GetAxisNum(const gert::Shape &shape, const QSFAV2Axis &axis, const QSFAV2Layout &layout)
{
    return HasAxis(axis, layout, shape) ? shape.GetDim(GetAxisIdx(axis, layout)) : kInvalidDimValue;
}

ge::graphStatus QSFAV2InfoParser::CheckTensorShapes() const
{
...
ge::graphStatus QSFAV2InfoParser::CheckTensorDescriptions() const
{
...
ge::graphStatus QSFAV2InfoParser::CheckRequiredInOutExistence() const
{
...
ge::graphStatus QSFAV2InfoParser::CheckRequiredAttrExistence() const
{
...
ge::graphStatus QSFAV2InfoParser::CheckRequiredParaExistence() const
{
...
ge::graphStatus QSFAV2InfoParser::GetActualSeqLenQSize(uint32_t &size)
{
    return GetActualSeqLenSize(size, opParamInfo_.actualSeqLengthsQ.tensor, "actual_seq_lengths_query", opName_);
}

ge::graphStatus QSFAV2InfoParser::GetOpName()
{
    if (context_->GetNodeName() == nullptr) {
        OP_LOGE("KvQuantSparseFlashAttentionV2", "opName got from TilingContext is nullptr");
        return ge::GRAPH_FAILED;
    }
...
ge::graphStatus QSFAV2InfoParser::GetNpuInfo()
{
...
void QSFAV2InfoParser::GetOptionalInputParaInfo()
{
...
void QSFAV2InfoParser::GetInputParaInfo()
{
...
void QSFAV2InfoParser::GetOutputParaInfo()
{
...
ge::graphStatus QSFAV2InfoParser::GetAttrParaInfo()
{
...
ge::graphStatus QSFAV2InfoParser::GetOpParaInfo()
{
    GetInputParaInfo();
    GetOutputParaInfo();
...
ge::graphStatus QSFAV2InfoParser::GetInOutDataType()
{
...
ge::graphStatus QSFAV2InfoParser::GetBatchSize()
{
    // 获取B基准值
    // 1、非TND时, 以query的batch_size维度为基准;
    // 2、TND时, actual_seq_lens_q必须传入, 以actual_seq_lens_q数组的长度为B轴大小
    if (qLayout_ == QSFAV2Layout::TND) {
        return GetActualSeqLenQSize(bSize_);
    } else { // BSND
        bSize_ = GetAxisNum(queryShape_, QSFAV2Axis::B, qLayout_);
        return ge::GRAPH_SUCCESS;
    }
}

ge::graphStatus QSFAV2InfoParser::GetQTSize()
{
    // 获取query的T基准值
    // 1、非TND时, 以query的batch_size维度为基准;
    // 2、TND时, actual_seq_lens_q必须传入, 以actual_seq_lens_q数组的长度为B轴大小
    qTSize_ = (qLayout_ == QSFAV2Layout::TND) ? GetAxisNum(queryShape_, QSFAV2Axis::T, qLayout_) : 0;
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2InfoParser::GetKVTSize()
{
    // 获取query的T基准值
    // 1、非TND时, 以key的batch_size维度为基准;
    // 2、TND时, actual_seq_lens_q必须传入, 以actual_seq_lens_q数组的长度为B轴大小
    kvTSize_ = (kvLayout_ == QSFAV2Layout::TND) ? GetAxisNum(keyShape_, QSFAV2Axis::T, kvLayout_) : 0;
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2InfoParser::GetQHeadDim()
{
    // 获取qHeadDim基准值
    // 以query的D维度为基准
    qHeadDim_ = GetAxisNum(queryShape_, QSFAV2Axis::D, qLayout_);
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2InfoParser::GetKHeadDim()
{
    // 获取kHeadDim基准值
    // 以key的D维度为基准
    kHeadDim_ = GetAxisNum(keyShape_, QSFAV2Axis::D, kvLayout_);
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2InfoParser::GetS1Size()
{
    // 获取S1基准值
    // 1、非TND时, 以query的S维度为基准;
    // 2、TND时, actual_seq_lens_q必须传入, 以actual_seq_lens_q数组中的最大值为基准
    if (qLayout_ == QSFAV2Layout::TND) {
        s1Size_ = GetAxisNum(queryShape_, QSFAV2Axis::T, qLayout_);
        return ge::GRAPH_SUCCESS;
    } else { // BSND
        s1Size_ = GetAxisNum(queryShape_, QSFAV2Axis::S, qLayout_);
    }
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2InfoParser::GetKvStorageMode()
{
    if (kvLayout_ == QSFAV2Layout::PA_BSND) {
...
ge::graphStatus QSFAV2InfoParser::GetKvLayout()
{
    const map<string, QSFAV2Layout> layoutKVMap = {
        {"BSND", QSFAV2Layout::BSND}, {"PA_BSND", QSFAV2Layout::PA_BSND}, {"TND", QSFAV2Layout::TND}};
    ...
    if (kvLayout_ != QSFAV2Layout::PA_BSND && qLayout_ != kvLayout_) {
        OP_LOGE_FOR_INVALID_VALUES_WITH_REASON(
            opName_, "layout_kv and layout_query",
            QSFAV2LayoutToSerialString(kvLayout_) + " and " + QSFAV2LayoutToSerialString(qLayout_),
    ...
    if (kvLayout_ == QSFAV2Layout::PA_BSND && keyDimNum != 4U) {
...
ge::graphStatus QSFAV2InfoParser::GetS2SizeForBatchContinuous()
{
    if (kvLayout_ == QSFAV2Layout::BSND) { // BSND
        s2Size_ = GetAxisNum(keyShape_, QSFAV2Axis::S, kvLayout_);
    } else if (kvLayout_ == QSFAV2Layout::TND) { // TND
        s2Size_ = GetAxisNum(keyShape_, QSFAV2Axis::T, kvLayout_);
    }

    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2InfoParser::GetMaxBlockNumPerBatch()
{
    if (opParamInfo_.blockTable.tensor == nullptr) {
        OP_LOGE_FOR_INVALID_ARGUMENT_WITH_REASON(
            opName_, "block_table",
            "The layout_kv is " + QSFAV2LayoutToSerialString(kvLayout_) + ", block_table must be provided");
        return ge::GRAPH_FAILED;
    }
...
ge::graphStatus QSFAV2InfoParser::GetSparseBlockCount()
{
    sparseBlockCount_ = GetAxisNum(sparseIndicesShape_, QSFAV2Axis::K, qLayout_);

    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2InfoParser::GetBlockSize()
{
    blockSize_ = GetAxisNum(keyShape_, QSFAV2Axis::Bs, kvLayout_);
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2InfoParser::GetS2SizeForPageAttention()
{
...
ge::graphStatus QSFAV2InfoParser::GetS2Size()
{
    // 获取S2基准值
...
ge::graphStatus QSFAV2InfoParser::GetValueHeadDim()
{
    // 获取vHeadDim基准值
    // 以value的D维度为基准
    vHeadDim_ = GetAxisNum(valueShape_, QSFAV2Axis::D, kvLayout_);
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2InfoParser::GetDSizeKV()
{
    dSizeKV_ = GetAxisNum(keyShape_, QSFAV2Axis::D, kvLayout_);
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2InfoParser::GetQueryAndOutLayout()
{
    // 获取query和attentionOut的Layout基准值
    // layoutQuery: {qLayout, outLayout}
    const std::map<std::string, std::pair<QSFAV2Layout, QSFAV2Layout>> qsfaLayoutMap = {
        {"BSND", {QSFAV2Layout::BSND, QSFAV2Layout::BSND}},
        {"TND", {QSFAV2Layout::TND, QSFAV2Layout::TND}},
    };
...
ge::graphStatus QSFAV2InfoParser::GetTopkLayout()
{
    topkLayout_ = qLayout_;
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2InfoParser::GetN1Size()
{
    n1Size_ = GetAxisNum(queryShape_, QSFAV2Axis::N, qLayout_);
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus QSFAV2InfoParser::GetN2Size()
{
    n2Size_ = GetAxisNum(keyShape_, QSFAV2Axis::N, kvLayout_);
    return ge::GRAPH_SUCCESS;
}

void QSFAV2InfoParser::SetQSFAV2Shape()
{
...
ge::graphStatus QSFAV2InfoParser::GetGSize()
{
    if (n2Size_ != 0) {
...
ge::graphStatus QSFAV2InfoParser::GetActualseqInfo()
{
...
// 非PA_BSND时，所有轴都必须连续
ge::graphStatus QSFAV2InfoParser::CheckContiguous() const
{
    if (!isA5_) {
        return ge::GRAPH_SUCCESS;
    }
...
ge::graphStatus QSFAV2InfoParser::GetShapeAndSizeInfo()
{
    SetQSFAV2Shape();
...
void QSFAV2InfoParser::GenerateInfo(QSFAV2TilingInfo &qsfaInfo)
{
...
void QSFAV2InfoParser::FillTilingInfoAttrsAndLayouts(QSFAV2TilingInfo &qsfaInfo)
{
...
ge::graphStatus QSFAV2InfoParser::Parse(QSFAV2TilingInfo &qsfaInfo)
{
    if (context_ == nullptr) {
        OP_LOGE("KvQuantSparseFlashAttentionV2", "tiling context is nullptr");
        return ge::GRAPH_FAILED;
    }
...
IMPL_OP_OPTILING(KvQuantSparseFlashAttentionV2)
    .Tiling(TilingKvQuantSparseFlashAttentionV2)
    .TilingParse<KvQuantSparseFlashAttentionV2CompileInfo>(TilingPrepareForKvQuantSparseFlashAttentionV2);
} // namespace optiling
