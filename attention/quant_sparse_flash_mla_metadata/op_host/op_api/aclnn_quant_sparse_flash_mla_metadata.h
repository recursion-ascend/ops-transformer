...
#ifndef ACLNN_quant_sparse_flash_mla_metadata_H
#define ACLNN_quant_sparse_flash_mla_metadata_H
...
__attribute__((visibility("default"))) aclnnStatus aclnnQuantSparseFlashMlaMetadataGetWorkspaceSize(
...
#endif // ACLNN_quant_sparse_flash_mla_metadata_H