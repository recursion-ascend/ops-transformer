...
#ifndef ACLNN_SPARSE_FLASH_MLA_GRAD_METADATA_H
#define ACLNN_SPARSE_FLASH_MLA_GRAD_METADATA_H
...
__attribute__((visibility("default"))) aclnnStatus aclnnSparseFlashMlaGradMetadataGetWorkspaceSize(
...
#endif // ACLNN_SPARSE_FLASH_MLA_GRAD_METADATA_H
