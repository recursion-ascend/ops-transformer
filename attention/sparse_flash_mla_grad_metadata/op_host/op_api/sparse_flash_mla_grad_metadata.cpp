...
using namespace op;
namespace l0op {
OP_TYPE_REGISTER(SparseFlashMlaGradMetadata);
...
{
    L0_DFX(SparseFlashMlaGradMetadata, cuSeqlensQOptional, cuSeqlensOriKvOptional, cuSeqlensCmpKvOptional,
    ...
    static internal::AicpuTaskSpace space("SparseFlashMlaGradMetadata");
    ...
    OP_CHECK(ret == ACL_SUCCESS,
             OP_LOGE(ACLNN_ERR_INNER_NULLPTR, "SparseFlashMlaGradMetadata ADD_TO_LAUNCHER_LIST_AICPU failed."),
             return nullptr);
    return metaData;
}
