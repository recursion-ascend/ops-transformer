...
TestCases = {
    ...
    "aclnnFusedInferAttentionScoreV5_FIA_24_16_1_2206_2048_case49": {
        ...
        "cu_seqlens_q": [
            [
                0, 586, 1180, 3149, 3186, 5216, 6778, 8031, 10003, 11078,
                13108, 14950, 16701, 18718, 19934, 21136, 22634, 23795, 24212, 25687,
                25719, 27795, 28192, 29494, 29640,
            ],
        ],
        "cu_seqlens_kv": [
            [
                0, 1919, 3023, 3774, 4937, 5164, 5576, 7117, 8066, 9923,
                11309, 12360, 14040, 14239, 15184, 15339, 16086, 17372, 17372, 19066,
                19785, 20802, 21123, 22587, 24241,
            ],
        ],
        # # seqused: (B,) 各请求实际使用长度
    ...
    "aclnnFusedInferAttentionScoreV5_FIA_30_64_2_3089_4096_case123": {
        ...
        "seqused_q": [
            [
                174, 1866, 2088, 2639, 2914, 734, 525, 2282, 1945, 2514,
                911, 1645, 2291, 2739, 2913, 342, 1613, 114, 2470, 1653,
                3074, 2182, 2285, 1509, 1135, 291, 1818, 2511, 2508, 747,
            ],
        ],
    ...
    "aclnnFlashAttn_16_180_12_253_1600_case301": {
        ...
        "seqused_kv": [
            [
                1357, 1085, 35, 1091, 37, 393, 380, 686, 648, 667,
                1448, 999, 387, 1337, 690, 513,
            ],
        ],
        "block_table_shape": [[16, 1536]],
        "block_size": [256],
    ...
    "aclnnFlashAttn_30_64_2_3089_4096_case302": {
        ...
        "seqused_kv": [
            [
                1725, 2862, 4079, 2690, 646, 0, 270, 3561, 2155, 121,
                185, 2129, 3018, 2007, 1898, 2142, 3211, 2158, 3388, 2646,
                2047, 566, 275, 4030, 995, 2893, 3107, 3097, 3607, 214,
            ],
        ],
        "block_table_shape": [[30, 4096]],
        "block_size": [128],
