...
if _TORCHAIR_AVAILABLE:
    ...
    @register_fx_node_ge_converter(
        torch.ops.cann_ops_transformer.fused_causal_conv1d.default
    )
    def converter_fused_causal_conv1d(
        x: Tensor,
        weight: Tensor,
        conv_states: Tensor,
        *,
        ...
        _conv_states_out, y = FusedCausalConv1d(
            x,
            weight,
            conv_states,
            query_start_loc,
    ...
    def convert_fused_causal_conv1d(*args, **kwargs):
        raise RuntimeError(
