...
/*!
 * \file infer_flash_attention_sparse_fused_infer.h
 * \brief
 */
#ifndef INFER_FLASH_ATTENTION_SPARSE_FUSED_INFER_H
#define INFER_FLASH_ATTENTION_SPARSE_FUSED_INFER_H
...
#endif // INFER_FLASH_ATTENTION_SPARSE_FUSED_INFER_H
