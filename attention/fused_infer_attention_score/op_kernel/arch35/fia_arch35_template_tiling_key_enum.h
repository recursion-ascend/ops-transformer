...
/*!
 * \file fia_arch35_template_tiling_key_enum.h
 * \brief FIA arch35 tiling key enum definitions (decoupled from PFA)
 */

#ifndef FIA_ARCH35_TEMPLATE_TILING_KEY_ENUM_H_
#define FIA_ARCH35_TEMPLATE_TILING_KEY_ENUM_H_
...
#define AntiquantMode_K_PER_TOKEN 6
