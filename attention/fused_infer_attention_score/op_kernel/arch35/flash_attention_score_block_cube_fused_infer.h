...
/*!
 * \file flash_attention_score_block_cube_fused_infer.h
 * \brief
 */
#ifndef FLASH_ATTENTION_SCORE_BLOCK_CUBE_H__FUSED_INFER
#define FLASH_ATTENTION_SCORE_BLOCK_CUBE_H__FUSED_INFER
...
#endif // FLASH_ATTENTION_SCORE_BLOCK_CUBE_H__FUSED_INFER
