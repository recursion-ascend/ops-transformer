...
ASCENDC_TPL_ARGS_DECL(FusedInferAttentionScore,
                      ...
                      /*
                          To ensure template compatibility and reduce total tilingkey, KvLayoutType is assigned
                         different optional values for kernel templates before/after refactoring.
                          1. For refactored template(e.g. GQA non quant), KvLayoutType is template parameterized,
                         KvLayoutType_NO_PA, KvLayoutType_PA_BBH, KvLayoutType_PA_BNBD, KvLayoutType_PA_NZ are required.
                          2. For unrefactored templates, KvLayoutType_NO_PA and KvLayoutType_ENABLE_PA are recommended
                         to reduce tilingkey and keep compatibility, KvLayoutType has same meaning as the original isPa.
                      */
...
// ifa
    ...
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(InOutLayoutType, ASCENDC_TPL_UI_LIST, InOutLayoutType_BNSD_BNSD,
                                              InOutLayoutType_BSH_BSH, InOutLayoutType_TND_TND),
                         ASCENDC_TPL_UINT_SEL(Config, ASCENDC_TPL_UI_LIST,
                                              Config_S1Aligned16_S2Aligned1024_DAligned64_DVAligned64),
    ...
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(InOutLayoutType, ASCENDC_TPL_UI_LIST, InOutLayoutType_BNSD_BNSD,
                                              InOutLayoutType_BSH_BSH, InOutLayoutType_TND_TND),
                         ASCENDC_TPL_UINT_SEL(Config, ASCENDC_TPL_UI_LIST,
                                              Config_S1Aligned32_S2Aligned512_DAligned64_DVAligned64,
    ...
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(InOutLayoutType, ASCENDC_TPL_UI_LIST, InOutLayoutType_BNSD_BNSD,
                         ...
                         ASCENDC_TPL_BOOL_SEL(HasAttenMask, false, true), ASCENDC_TPL_BOOL_SEL(HasRope, false),
                         ASCENDC_TPL_UINT_SEL(KvLayoutType, ASCENDC_TPL_UI_LIST, KvLayoutType_NO_PA,
                                              KvLayoutType_PA_BBH, KvLayoutType_PA_BNBD, KvLayoutType_PA_NZ),
                         ASCENDC_TPL_BOOL_SEL(IsFd, true), ASCENDC_TPL_BOOL_SEL(EmptyTensor, 0),
                         ASCENDC_TPL_BOOL_SEL(EnableKVPrefix, false), ASCENDC_TPL_BOOL_SEL(EnableS1OutSplit, false),
                         ASCENDC_TPL_BOOL_SEL(IsReconstructTemp, true),
                         ASCENDC_TPL_TILING_STRUCT_SEL(FusedInferAttentionScoreTilingData)),
