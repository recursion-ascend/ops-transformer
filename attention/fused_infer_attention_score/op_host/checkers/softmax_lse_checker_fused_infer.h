...
/*!
 * \file softmax_lse_checker_fused_infer.h
 * \brief
 */

#ifndef SOFTMAX_LSE_CHECKER_FUSED_INFER_H
#define SOFTMAX_LSE_CHECKER_FUSED_INFER_H
...
#endif // SOFTMAX_LSE_CHECKER_FUSED_INFER_H