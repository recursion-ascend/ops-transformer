...
TEST_P(FusedInferAttentionScoreArch22TilingTest, param)
{
    ...
    if (!param.isTensorList) {
        gert::TilingContextPara tilingContextPara(
            ...
            param.inputInstance, param.outputInstance, &compileInfo, "Ascend910B", 40, 196608, 4096, A2SocInfo);
    ...
    gert::TilingContextPara tilingContextPara(
        ...
        inputInstanceNum, outputInstanceNum, &compileInfo, "Ascend910B", 40, 196608, 4096, A2SocInfo);
...
INSTANTIATE_TEST_SUITE_P(
    FusedInferAttentionScore, FusedInferAttentionScoreArch22TilingTest,
