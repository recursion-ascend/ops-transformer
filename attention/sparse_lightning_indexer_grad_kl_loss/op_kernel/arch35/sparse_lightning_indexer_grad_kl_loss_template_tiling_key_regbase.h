...
ASCENDC_TPL_ARGS_DECL(SparseLightningIndexerGradKLLoss, // 算子OpType
                      ...
                      ASCENDC_TPL_BOOL_DECL(DETERMINISTIC, 0, 1), ASCENDC_TPL_BOOL_DECL(HASSINK, 0, 1), );
...
ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(
    ...
    ASCENDC_TPL_UINT_SEL(SPARSE_MODE, ASCENDC_TPL_UI_LIST, 3), ASCENDC_TPL_BOOL_SEL(DETERMINISTIC, 0, 1),
    ASCENDC_TPL_BOOL_SEL(HASSINK, 0, 1),
