...
ASCENDC_TPL_ARGS_DECL(SparseLightningIndexerGradKLLoss, // 算子OpType
                      ...
                      ASCENDC_TPL_UINT_DECL(TOPK_RANGE, ASCENDC_TPL_14_BW, ASCENDC_TPL_UI_LIST, 1024, 2048, 3072, 4096,
                                            5120, 6144, 7168, 8192),
...
ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(
    ...
    ASCENDC_TPL_UINT_SEL(SPARSE_MODE, ASCENDC_TPL_UI_LIST, MQA_SPARSE), ASCENDC_TPL_BOOL_SEL(DETERMINISTIC, 0, 1),
