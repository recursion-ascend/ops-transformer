...
struct BlockSparseAttentionKernelParams {
    ...
    // 带参数的构造函数(新增了参数的构造器)
    __aicore__ inline BlockSparseAttentionKernelParams(GM_ADDR q_, GM_ADDR k_, GM_ADDR v_, GM_ADDR blockSparseMask_,
                                                       GM_ADDR mask_, GM_ADDR blockTables_, GM_ADDR actualQseqlen_,
                                                       GM_ADDR actualKvseqlen_, GM_ADDR o_, GM_ADDR lse_,
