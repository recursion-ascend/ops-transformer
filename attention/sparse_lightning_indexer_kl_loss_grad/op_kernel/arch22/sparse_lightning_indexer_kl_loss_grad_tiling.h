...
public:
    ...
    int64_t get_cmpRatio() const
    {
        return cmpRatio;
    }
    void set_cmpRatio(int64_t cmpRatioParam)
    {
        this->cmpRatio = cmpRatioParam;
    }

    int64_t get_hasSoftmaxInput() const
    {
        return hasSoftmaxInput;
    }
    void set_hasSoftmaxInput(int64_t hasSoftmaxInputParam)
    {
        this->hasSoftmaxInput = hasSoftmaxInputParam;
    }
