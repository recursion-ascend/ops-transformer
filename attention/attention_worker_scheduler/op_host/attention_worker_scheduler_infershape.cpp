...
graphStatus InferDtype4AttentionWorkerScheduler(gert::InferDataTypeContext *context)
{
    OP_LOGD(context->GetNodeName(), "InferDtype4AttentionWorkerScheduler enter");
    ...
    OP_LOGD(context->GetNodeName(), "InferDtype4AttentionWorkerScheduler end");
    return GRAPH_SUCCESS;
}

IMPL_OP_INFERSHAPE(AttentionWorkerScheduler)
    .InferShape(Ops::Base::InferShape4Elewise)
    .InferDataType(InferDtype4AttentionWorkerScheduler);
