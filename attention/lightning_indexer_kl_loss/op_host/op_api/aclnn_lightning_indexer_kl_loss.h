...
#ifndef OP_API_INC_LIGHTNING_INDEXER_KL_LOSS_H_
#define OP_API_INC_LIGHTNING_INDEXER_KL_LOSS_H_
...
/**
 * @brief aclnnLightningIndexerKLLoss的第一段接口，根据具体的计算流程，计算workspace大小。
...
/**
 * @brief aclnnLightningIndexerKLLoss的第二段接口，用于执行计算。
 */
...
#endif // OP_API_INC_LIGHTNING_INDEXER_KL_LOSS_H_
