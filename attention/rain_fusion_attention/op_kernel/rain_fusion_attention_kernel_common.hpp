...
struct RainFusionAttentionKernelParams {
    ...
    // 默认构造函数
    __aicore__ inline RainFusionAttentionKernelParams() {}

    // 带参数的构造函数
    __aicore__ inline RainFusionAttentionKernelParams(GM_ADDR q_, GM_ADDR k_, GM_ADDR v_, GM_ADDR mask_,
                                                      GM_ADDR blockTables_, GM_ADDR actualQseqlen_,
                                                      GM_ADDR actualKvseqlen_, GM_ADDR selectIdx_,
                                                      GM_ADDR selectNumIdx_, GM_ADDR o_, GM_ADDR lse_,
