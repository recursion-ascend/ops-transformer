...
/* !
 * \file vf_cast_dup_dense_kl_loss_grad.h
 * \brief
 */
#ifndef VF_CAST_DUP_DENSE_KL_LOSS_GRAD_H
#define VF_CAST_DUP_DENSE_KL_LOSS_GRAD_H
...
#endif // VF_CAST_DUP_DENSE_KL_LOSS_GRAD_H
