...
{
    L0_DFX(RecurrentKda, query, key, value, gate, beta, initialStateRef, cuSeqlensOptional, ssmStateIndicesOptional,
           aLogOptional, dtBiasOptional, numAcceptedTokensOptional, layout, scale, outputFinalState, inplaceFinalState,
           useQkL2normInKernel, useGateInKernel, useBetaSigmoidInKernel, allowNegEigval, safeGate, lowerBound,
           stateVFirst, attnOut, initialStateRef, finalState);
    ...
    auto ret = ADD_TO_LAUNCHER_LIST_AICORE(
        ...
        OP_ATTR(layout, scaleAttr, outputFinalState, inplaceFinalState, useQkL2normInKernel, useGateInKernel,
                useBetaSigmoidInKernel, allowNegEigval, safeGate, lowerBoundAttr, stateVFirst));
