...
REGISTER_CUSTOM_OP("EmbeddingBag")
    .FrameworkType(ONNX)
    .OriginOpType({ge::AscendString("ai.onnx::8::EmbeddingBag"), ge::AscendString("ai.onnx::9::EmbeddingBag"),
                   ge::AscendString("ai.onnx::10::EmbeddingBag"), ge::AscendString("ai.onnx::11::EmbeddingBag"),
                   ge::AscendString("ai.onnx::12::EmbeddingBag"), ge::AscendString("ai.onnx::13::EmbeddingBag"),
                   ge::AscendString("ai.onnx::14::EmbeddingBag"), ge::AscendString("ai.onnx::15::EmbeddingBag"),
