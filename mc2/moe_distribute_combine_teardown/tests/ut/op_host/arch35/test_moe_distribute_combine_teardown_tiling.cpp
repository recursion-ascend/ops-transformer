...
static MoeDistributeCombineTeardownTestParam g_testCases[] = {
    ...
    {"moe_combine_teardown_group_ep_too_long_error_47",
     ...
     ge::DT_BF16,
     ge::FORMAT_ND,
     "hccl_world_group_very_long_name_that_exceeds_the_maximum_allowed_length_of_127_characters_for_group_ep_attribute_"
     "in_moe_distribute_combine_teardown_operator",
     2,
     0,
     32,
     0,
