...
ASCENDC_TPL_ARGS_DECL(Mc2MatmulReduceScatterV2, // 算子OpType
                      ASCENDC_TPL_BOOL_DECL(TPL_ISBIAS, 0, 1), ASCENDC_TPL_BOOL_DECL(TPL_IS_TRANSPOSE_A, 0, 1),
                      ASCENDC_TPL_BOOL_DECL(TPL_IS_TRANSPOSE_B, 0, 1), ASCENDC_TPL_BOOL_DECL(TPL_IS_SMALLM, 0, 1),
...
ASCENDC_TPL_SEL(
    // aiv_mode_tiling
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_BOOL_SEL(TPL_ISBIAS, 0, 1), ASCENDC_TPL_BOOL_SEL(TPL_IS_TRANSPOSE_A, 0),
                         ASCENDC_TPL_BOOL_SEL(TPL_IS_TRANSPOSE_B, 0, 1), ASCENDC_TPL_BOOL_SEL(TPL_IS_SMALLM, 0, 1),
