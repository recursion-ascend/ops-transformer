...
static MoeDistributeDispatchSetupTilingTestParam test_cases[] = {
    ...
    {2,
     3,
     "quantMode_boundary_invalid_minus1",
     "3510",
     {16, 4096},
     {16, 6},
     ge::DT_FLOAT16,
    ...
    {2,
     3,
     "quantMode_boundary_valid_0_unquant",
     "3510",
     {16, 4096},
     {16, 6},
     ge::DT_FLOAT16,
    ...
    {2,
     3,
     "quantMode_boundary_valid_4_mx_quant",
     "3510",
     {16, 4096},
     {16, 6},
     ge::DT_FLOAT16,
    ...
    {2,
     3,
     "normal_quant1_static_int8_tk1001",
     "3510",
     {16, 4096},
     {16, 6},
     ge::DT_FLOAT16,
    ...
    {2,
     3,
     "normal_quant1_static_hif8_tk1001",
     "3510",
     {16, 4096},
     {16, 6},
     ge::DT_FLOAT16,
    ...
    {2,
     3,
     "normal_quant2_pertoken_int8_tk1002",
     "3510",
     {16, 4096},
     {16, 6},
     ge::DT_FLOAT16,
    ...
    {2,
     3,
     "normal_quant3_pergroup_fp8e4m3_tk1003",
     "3510",
     {16, 4096},
     {16, 6},
     ge::DT_FLOAT16,
    ...
    {2,
     3,
     "normal_quant4_mx_fp8e5m2_tk1004",
     "3510",
     {16, 4096},
     {16, 6},
     ge::DT_FLOAT16,
    ...
    {2,
     3,
     "normal_ep_rank_nonzero_moe_card",
     "3510",
     {16, 4096},
     {16, 6},
     ge::DT_FLOAT16,
    ...
    {2,
     3,
     "normal_all_optional_fp16_quant2",
     "3510",
     {16, 4096},
     {16, 6},
     ge::DT_FLOAT16,
    ...
    {2,
     3,
     "invalid_shared_rank_gt_half_ep",
     "3510",
     {16, 4096},
     {16, 6},
     ge::DT_FLOAT16,
    ...
    {2,
     3,
     "invalid_shared_rank_without_num",
     "3510",
     {16, 4096},
     {16, 6},
     ge::DT_FLOAT16,
    ...
    {2,
     3,
     "invalid_shared_rank_not_divisible",
     "3510",
     {16, 4096},
     {16, 6},
     ge::DT_FLOAT16,
    ...
    {2,
     3,
     "invalid_moe_not_divisible_by_ep",
     "3510",
     {16, 4096},
     {16, 6},
     ge::DT_FLOAT16,
    ...
    {2,
     3,
     "invalid_bs_mismatch_x_expert_ids",
     "3510",
     {16, 4096},
     {17, 6},
     ge::DT_FLOAT16,
    ...
    {2,
     3,
     "invalid_expand_idx_dtype_int64",
     "3510",
     {16, 4096},
     {16, 6},
     ge::DT_FLOAT16,
    ...
    {2,
     3,
     "invalid_comm_cmd_info_dtype_int64",
     "3510",
     {16, 4096},
     {16, 6},
     ge::DT_FLOAT16,
    ...
    {2,
     3,
     "invalid_expand_idx_dim0_mismatch",
     "3510",
     {16, 4096},
     {16, 6},
     ge::DT_FLOAT16,
...
static gert::TilingContextPara BuildTilingContextPara(const MoeDistributeDispatchSetupTilingTestParam &param)
{
    ...
    return gert::TilingContextPara(OP_NAME, inputTensorDesc, outputTensorDesc, attrs, inputInstanceNum,
                                   outputInstanceNum, &compileInfo, param.socVersion);
}

static void ThreadFunc(const MoeDistributeDispatchSetupTilingTestParam *testCases, size_t testcase_num,
...
static void TestMultiThread(const MoeDistributeDispatchSetupTilingTestParam *testCases, size_t testcase_num,
                            size_t thread_num)
{
...
INSTANTIATE_TEST_CASE_P(MoeDistributeDispatchSetupTilingUT, TestMoeDistributeDispatchSetupTiling,
