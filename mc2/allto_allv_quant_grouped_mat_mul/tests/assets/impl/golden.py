...
"""Golden for aclnnAlltoAllvQuantGroupedMatMul.
...
def allto_allv_quant_grouped_mat_mul_multi_device_golden(
    ...
    try:
        from ttk.core_modules.npu.op_api.hccl_cascade import run_alltoallv_gmm_cascade
        ...
        logging.exception("AlltoAllvQuantGroupedMatMul: cascade failed")
        rank_third_parties = None
...
def allto_allv_quant_grouped_mat_mul_e2e_golden(
