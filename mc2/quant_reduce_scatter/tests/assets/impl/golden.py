...
"""Golden for aclnnQuantReduceScatter.

QuantReduceScatter: dequant(x, scale) -> reduce_scatter(SUM).
"""
...
def quant_reduce_scatter_multi_device_golden(
...
def quant_reduce_scatter_e2e_golden(
