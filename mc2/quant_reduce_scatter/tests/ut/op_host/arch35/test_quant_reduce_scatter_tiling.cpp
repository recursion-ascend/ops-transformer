...
static QuantReduceScatterTestParam g_testCases[] = {
    {"quant_reduce_scatter_critical_case_1",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 5120 80 64 314572800 4398046514176 ",
     {16777216},
    ...
    {"quant_reduce_scatter_critical_case_2",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "2048 5120 40 64 314572800 4398046517248 ",
     {16777216},
     MC2_TILING_DATA_RESERVED_LEN},
    {"quant_reduce_scatter_critical_case_3",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 7168 56 64 314572800 4398046515200 ",
     {16777216},
     MC2_TILING_DATA_RESERVED_LEN},
    {"quant_reduce_scatter_critical_case_1_x3d",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 4096 64 64 314572800 4398046513152 ",
     {16777216},
     MC2_TILING_DATA_RESERVED_LEN},
    {"quant_reduce_scatter_critical_case_2_x3d",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "2048 4096 32 64 314572800 4398046516224 ",
     {16777216},
     MC2_TILING_DATA_RESERVED_LEN},
    {"quant_reduce_scatter_critical_case_3_x3d",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 8192 64 64 314572800 4398046516224 ",
     {16777216},
     MC2_TILING_DATA_RESERVED_LEN},
    ...
    {"quant_reduce_scatter_critical_case_rank2_mx",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 5120 80 64 314572800 4398046524416 ",
     {16777216},
     MC2_TILING_DATA_RESERVED_LEN},
    {"quant_reduce_scatter_critical_case_rank4_tg",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 5120 40 64 314572800 4398046517248 ",
     {16777216},
     MC2_TILING_DATA_RESERVED_LEN},
    {"quant_reduce_scatter_critical_case_H1024_tg",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 1024 8 64 314572800 4398046513152 ",
     {16777216},
     MC2_TILING_DATA_RESERVED_LEN},
    {"quant_reduce_scatter_critical_case_H8192_mx",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 8192 128 64 314572800 4398046516224 ",
     {16777216},
     MC2_TILING_DATA_RESERVED_LEN},
    ...
    {"quant_reduce_scatter_critical_case_3d_tg_int8_float_out",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 5120 40 64 314572800 4398046514176 ",
     {16777216},
     MC2_TILING_DATA_RESERVED_LEN},
    ...
    {"quant_reduce_scatter_critical_case_3d_tg_rank2",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 5120 40 64 314572800 4398046524416 ",
     {16777216},
     MC2_TILING_DATA_RESERVED_LEN},
    // --- 新增异常路径用例 ---
