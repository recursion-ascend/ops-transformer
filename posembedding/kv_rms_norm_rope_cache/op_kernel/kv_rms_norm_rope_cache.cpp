...
kv_rms_norm_rope_cache(GM_ADDR kv, GM_ADDR gamma, GM_ADDR cos, GM_ADDR sin, GM_ADDR index, GM_ADDR k_cache,
                       GM_ADDR ckv_cache, GM_ADDR k_rope_scale, GM_ADDR c_kv_scale, GM_ADDR k_rope_offset,
                       GM_ADDR c_kv_offset, GM_ADDR v, GM_ADDR k_cache_out, GM_ADDR c_kv_cache_out, GM_ADDR k_rope,
                       GM_ADDR c_kv, GM_ADDR workspace, GM_ADDR tiling)
{
    TPipe pipe;
    if (TILING_KEY_IS(KV_RMS_NORM_ROPE_CACHE_B16_NORM)) {
        ...
        op.Init(kv, gamma, cos, sin, index, k_cache, ckv_cache, k_rope, c_kv, k_rope_scale, c_kv_scale, k_rope_offset,
                c_kv_offset, v);
        op.Process();
        ...
        op.Init(kv, gamma, cos, sin, index, k_cache, ckv_cache, k_rope_scale, c_kv_scale, k_rope_offset, c_kv_offset, v,
                k_rope, c_kv);
        op.Process();
