...
/*!
 * \file aclnn_moe_gating_top_k_v2.h
 * \brief
 */

#ifndef OP_API_INC_MOE_GATING_TOP_K_V2_H_
#define OP_API_INC_MOE_GATING_TOP_K_V2_H_
...
/**
 * @brief aclnnMoeGatingTopKV2的第一段接口，根据具体的计算流程，计算workspace大小。
...
/* @brief aclnnMoeGatingTopKV2的第二段接口，用于执行计算。 */
