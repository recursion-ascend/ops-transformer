 ...
 */
#ifndef OP_API_INC_MOE_GATING_TOP_K_H_
#define OP_API_INC_MOE_GATING_TOP_K_H_
...
/**
 * @brief aclnnMoeGatingTopK的第一段接口，根据具体的计算流程，计算workspace大小。
...
/* @brief aclnnMoeGatingTopK的第二段接口，用于执行计算。 */
