...
template <typename T1, typename T2, typename T3, bool PROBS>
__aicore__ inline void KernelMoeTokenUnpermuteWithRoutingMap<T1, T2, T3, PROBS>::CalMultiOutToken(
...
template <typename T1, typename T2, typename T3, bool PROBS>
__aicore__ inline void KernelMoeTokenUnpermuteWithRoutingMap<T1, T2, T3, PROBS>::CalSingleOutToken(
...
template <typename T1, typename T2, typename T3, bool PROBS>
__aicore__ inline void KernelMoeTokenUnpermuteWithRoutingMap<T1, T2, T3, PROBS>::CalPartOutToken(
