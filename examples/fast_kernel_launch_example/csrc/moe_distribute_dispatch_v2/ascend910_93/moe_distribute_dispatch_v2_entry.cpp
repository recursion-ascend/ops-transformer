...
moe_distribute_dispatch_v2(GM_ADDR x, GM_ADDR expertIds, GM_ADDR scales, GM_ADDR xActiveMask, GM_ADDR expertScales,
                           GM_ADDR performanceInfo, GM_ADDR expandXOut, GM_ADDR dynamicScalesOut, GM_ADDR assistInfoOut,
                           GM_ADDR expertTokenNumsOut, GM_ADDR epSendCountsOut, GM_ADDR expandScalesOut,
                           GM_ADDR workspaceGM, GM_ADDR mc2Context, MoeDistributeDispatchV2Info tilingData)
{
    TPipe pipe;
    MoeDistributeDispatchV2<XType, ExpandxType, QuantMode, IsSmoothScaleExist> op;
    op.Init(mc2Context, x, expertIds, scales, xActiveMask, performanceInfo, expandXOut, dynamicScalesOut, assistInfoOut,
            expertTokenNumsOut, epSendCountsOut, workspaceGM, tilingData, &pipe);
...
template <typename XType, typename ExpandxType, int32_t QuantMode, bool IsSmoothScaleExist>
__attribute__((always_inline)) __aicore__ __inline__ void
moe_distribute_dispatch_v2_full_mesh(GM_ADDR x, GM_ADDR expertIds, GM_ADDR scales, GM_ADDR xActiveMask,
                                     GM_ADDR expertScales, GM_ADDR performanceInfo, GM_ADDR expandXOut,
                                     GM_ADDR dynamicScalesOut, GM_ADDR assistInfoOut, GM_ADDR expertTokenNumsOut,
                                     GM_ADDR epSendCountsOut, GM_ADDR expandScalesOut, GM_ADDR workspaceGM,
                                     GM_ADDR mc2Context, MoeDistributeDispatchV2Info tilingData)
{
    TPipe pipe;
    ...
    op.Init(x, expertIds, scales, xActiveMask, performanceInfo, expandXOut, dynamicScalesOut, assistInfoOut,
            expertTokenNumsOut, epSendCountsOut, workspaceGM, mc2Context, tilingData, &pipe);
...
__aicore__ inline void moe_dispatch_switch(int32_t tilingKey, GM_ADDR x, GM_ADDR expertIds, GM_ADDR scales,
                                           GM_ADDR xActiveMask, GM_ADDR expertScales, GM_ADDR performanceInfo,
    ...
    switch (tilingKey) {
        case 10000:
            moe_distribute_dispatch_v2<float16_t, float16_t, MoeDistributeDispatchV2Impl::UNQUANT, false>(
                x, expertIds, scales, xActiveMask, expertScales, performanceInfo, expandXOut, dynamicScalesOut,
                assistInfoOut, expertTokenNumsOut, epSendCountsOut, expandScalesOut, workspaceGM, mc2Context,
                tilingData);
            break;
        ...
        case 11002:
            moe_distribute_dispatch_v2_full_mesh<float16_t, int8_t, MoeDistributeDispatchV2Impl::PERTOKEN_DYNAMIC_QUANT,
                                                 false>(x, expertIds, scales, xActiveMask, expertScales,
                                                        performanceInfo, expandXOut, dynamicScalesOut, assistInfoOut,
                                                        expertTokenNumsOut, epSendCountsOut, expandScalesOut,
        ...
        case 11012:
            moe_distribute_dispatch_v2_full_mesh<bfloat16_t, int8_t,
                                                 MoeDistributeDispatchV2Impl::PERTOKEN_DYNAMIC_QUANT, false>(
                x, expertIds, scales, xActiveMask, expertScales, performanceInfo, expandXOut, dynamicScalesOut,
                assistInfoOut, expertTokenNumsOut, epSendCountsOut, expandScalesOut, workspaceGM, mc2Context,
                tilingData);
            break;
        ...
        case 11102:
            moe_distribute_dispatch_v2_full_mesh<float16_t, int8_t, MoeDistributeDispatchV2Impl::PERTOKEN_DYNAMIC_QUANT,
                                                 true>(x, expertIds, scales, xActiveMask, expertScales, performanceInfo,
                                                       expandXOut, dynamicScalesOut, assistInfoOut, expertTokenNumsOut,
                                                       epSendCountsOut, expandScalesOut, workspaceGM, mc2Context,
                                                       tilingData);
            break;
        ...
        case 11112:
            moe_distribute_dispatch_v2_full_mesh<bfloat16_t, int8_t,
                                                 MoeDistributeDispatchV2Impl::PERTOKEN_DYNAMIC_QUANT, true>(
                x, expertIds, scales, xActiveMask, expertScales, performanceInfo, expandXOut, dynamicScalesOut,
                assistInfoOut, expertTokenNumsOut, epSendCountsOut, expandScalesOut, workspaceGM, mc2Context,
                tilingData);
            break;
...
moe_distribute_dispatch_v2_generic(int32_t tilingKey, GM_ADDR x, GM_ADDR expertIds, GM_ADDR scales, GM_ADDR xActiveMask,
                                   GM_ADDR expertScales, GM_ADDR performanceInfo, GM_ADDR expandXOut,
                                   GM_ADDR dynamicScalesOut, GM_ADDR assistInfoOut, GM_ADDR expertTokenNumsOut,
                                   GM_ADDR epSendCountsOut, GM_ADDR expandScalesOut, GM_ADDR workspaceGM,
                                   GM_ADDR mc2Context, MoeDistributeDispatchV2Info tilingData)
{
    // 根据不同的数据类型调用不同的模板
    moe_dispatch_switch(tilingKey, x, expertIds, scales, xActiveMask, expertScales, performanceInfo, expandXOut,
                        dynamicScalesOut, assistInfoOut, expertTokenNumsOut, epSendCountsOut, expandScalesOut,
                        workspaceGM, mc2Context, tilingData);
}
...
void moe_distribute_dispatch_v2_entry(int32_t tilingKey, uint32_t blockDim, void *stream, GM_ADDR x, GM_ADDR expertIds,
                                      GM_ADDR scales, GM_ADDR xActiveMask, GM_ADDR expertScales,
                                      ...
                                      MoeDistributeDispatchV2Info tilingData)
{
    moe_distribute_dispatch_v2_generic<<<blockDim, nullptr, stream>>>(
        ...
        assistInfoOut, expertTokenNumsOut, epSendCountsOut, expandScalesOut, workspaceGM, mc2Context, tilingData);
}
